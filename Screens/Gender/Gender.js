...
import { setSelectedSingleGender} from '../../Redux/Action/Action';
...
const Gender = ({navigation}) => {
  ...
  const handleButtonPress = () => {
    if (selectedGender !== null) {
      dispatch(setSelectedSingleGender(selectedGender)); 
    }
    navigation.navigate('SingleInformationField');
  };

  const gender = ['Male', 'Female', 'Gay', 'Lesbian', 'Other'];

  const handleGenderPress = gender => {
    setSelectedGender(gender); 
    setSelectedSingleGender(gender); 
  };
