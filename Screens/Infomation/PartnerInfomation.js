...
const PartnerInfomation = ({navigation}) => {
      ...
      <SafeAreaView style={{flex: 1}}>
        ...
        <View style={styles.container}>
          <View style={styles.viewtext}>
            <Text style={styles.text}>Partner Information</Text>
            <Text style={styles.textStyle1}>
              Fill your Partner Infomation here !!
            </Text>
          </View>
        </View>
        <ScrollView style={{flex: 1}}>
          <Text style={styles.genderText1}>Partner Name</Text>
          ...
          <View
            ...
            <Touchable
              ...
              placeholder="Select Partner birthday"
              onPress={showDatePicker}
              value={selectedBirthday}
            />
            <Touchable
              label="Partner Height"
              placeholder="Select Partner height"
              placeholderTextColor={'#999'}
          ...
          <View
            ...
            <Text style={{fontSize: 16}}>
              {' '}
              select your Partner interest from options below{' '}
            </Text>
            <View
              style={{
                flexDirection: 'row',
...
export default PartnerInfomation;
