...
const SingleInformationField = ({navigation}) => {
  ...
  const Gender = useSelector(state => state.selectedSingleGender);
  ...
  const showIntrestModal = () => {
    setIntrestVisible(true);
  };
  ...
  const handleNavigation = () => {
    navigation.navigate('SingleLooking');
  };
    ...
    <>
      <SafeAreaView style={{flex: 1}}>
        ...
        <Orientation
          ...
          onClose={hideOrientationModal}
          onSubmit={handleOrientationSelection}
        />
...
export default SingleInformationField;
